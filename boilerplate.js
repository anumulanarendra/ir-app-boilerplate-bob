...
async function install (context) {
  ...
  const spinner = print
    .spin(`using the ${blue('Ignite React App')} boilerplate v2 (code name 'Bob')`)
    .succeed()
  ...
  try {
    ...
    const boilerplate = parameters.options.b || parameters.options.boilerplate || parameters.first // 'ir-app-boilerplate-bob'
